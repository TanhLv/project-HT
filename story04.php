...
<main>
    ...
    <div class="containers story__01" id="banner">
        <img src="asstes/img/2021_07_10_15_48_52-bảo hiểm cssj.png" alt="" class="story--img">
    </div>

    <div class="story__title containers family__border">
        <div class="story03__title--header">
            <h3>Dai-ichi Life GLOBAL health care card benefits</h3>
            <p>
                The GLOBAL HEALTH CARE card of Dai-ichi Life Company is the most trusted product. 
                With high benefits and optimal costs. With the motto that health is the most 
                precious capital, Dai-ichi Life Vietnam 
                brings the optimal solution so that everyone's home and people are protected.
            </p>

          <ul>
            <li>Protect family members against any health risks.</li>
            <li>Covering 100% of treatment costs from the smallest health problems: Flu,
                 fever, cough to incurable diseases.</li>
            <li>Health care package covers 100% of inpatient expenses up to 1 billion VND for 1 illness/1 
                injury/year for PREMIUM card and 300,000,000 VND/sickness/year for General card</li>
            <li>Guaranteed hospital fees with 1 card of Dai-ichi Life in over 200 hospitals 
                nationwide. Including international and public hospitals. INTERNATIONAL 
                Hospitals such as Vinmec, Hong Ngoc, Thu Cuc, Viet - France, Phuong Dong .... Public 
                Hospitals: 108 Central Military Hospital, National Children's Hospital, Thanh Nhan Hospital,
                 Duc Giang, Central Hospital for Tropical Diseases 1 & 2, Oncology Hanoi.</li>
            <li>Full payment of treatment costs at public hospitals at the district and higher levels.</li>
          </ul>
        </div>
