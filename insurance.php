...
<div class="containers" id="banner">
    <img src="asstes/img/be.png" alt="">
</div>
        ...
        <div class="baby__header container">
            ...
            <div class="mother__header">
                <div class="mother__title">
                    <h3>WHY SHOULD BUY INSURANCE FOR BABY?</h3>
                    <h4><i>When your child is an adult, how old will you be?</i></h4>
                    <p>As your child grows older and more needs arise, you will definitely 
                        need your support: go to college, start a business, buy a house, get married...
                    </p>
                    <p>
                        However, at that time you are also old, the ability to make money is no 
                        longer as "vigorous" as when you were young. Therefore, many parents have 
                        chosen the option of participating in life insurance for their children to 
                        save money 
                        right now, later in life, to avoid having to worry about money problems.
                    </p>
                </div>
            </div>
            ...
            <div class="mother__main">
                <div class="mother__main--title">
                    <p> There are 2 important milestones that parents often pay attention to:</p>
                </div>
                <div class="baby__main--titles">
                    <ul>
                        <li><b>When children reach 18 years of age:</b> This is the time to decide on 
                            choosing a career at the University. If the child's English level is good, 
                            it is possible for him to study abroad to have a stronger foundation.
                            <p>However, to do that, parents need to think about disciplined savings 
                                right now to have enough money for their children to study abroad. 
                                On the contrary, if you do not want to study abroad anymore, the life 
                                insurance company 
                                will also return this money for your child to use for other purposes.</p>
                        </li>
                        <li>
                            <b>When children reach 22 years of age: </b>
                                This is usually the time when the child has graduated from the University, 
                                or if the child is good at studying, he or she will want to study for a 
                                Master's or Doctoral degree; or if they don't choose an education, they may 
                                have the intention 
                                of starting their own business; or simply getting married, buying a house...
                        </li>
                    </ul>
                    <p>In all cases, family support is needed. Therefore,
                         it is very important to save disciplined right now.
                    </p>
                    <p>
                        Daiichi Life Japan is proud to be the number 1 prestigious unit in Japan 
                        and Vietnam. Not only is a long-term financial plan for children, 
                        but also the best medical care program with the following advantages:
                    </p>
                    <p>
                        - Unlimited number of diseases
                    </p>
                    <p>
                        - Unlimited amount of payment per treatment session
                    </p>
                    <p> - 100% support for cancer treatment costs</p>
                    <p>
                        - Exclude disease at least in the market (especially baby diseases)
                    </p>
                    <p>
                        - Protection of congenital diseases
                    </p>
                </div>
                <div class="baby__price">
                    <p><b><i>Only from 1,000,000 VND/month</i></b></p>
                    <p>The future of the child depends on the decisions of the parents. 
                        Be the most unified parents from today!
                    </p>
                    <p>
                        If you are wondering which insurance to buy for your child, how much it is, please leave your phone numbe
                         or contact the hotline/zalo directly to chat with the Consultants: <b>0339202500</b>
                    </p>
                </div>
            </div>
